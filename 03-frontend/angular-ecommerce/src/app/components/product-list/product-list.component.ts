...
export class ProductListComponent implements OnInit {
  ...
  handleSearchProducts() {
    ...
    //now search for the prducts using keyword
    this.productService
  ...
  handleListProducts() {
    ...
    if (hasCategoryId) {
      //get the "id" param string. Convert the string to a number using + symbol
    ...
    // Note: Angular will resue a component if it is currently being viewed
    //
